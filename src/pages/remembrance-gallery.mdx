...
---
import BambooChart from '../components/BambooChart'
...
The fundraising goal is $2 million  with a completion date of May 2024. <BambooChart width={300} height={540} amount={1700000} /> 
