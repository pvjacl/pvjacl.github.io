...
description: 'Learn more about the “Puyallup Assembly Center” (PAC), American concentration camps, and the wrongful incarceration of Japanese and Japanese Americans.'
pubDate: Dec 8 2023
layout: '@layouts/GalleryLayout.astro'
---
import imgPACAerial from '../gallery/assets/_PAC_aerial.jpg';
import imgPACBarracks from '../gallery/assets/_PAC_family-barracks.jpg';
import imgPACStall from '../gallery/assets/_San-Bruno_Konda-family_horse-stall.jpg';
...
<GalleryPhoto title="Family in the Puyallup Assembly Center Barracks" description="Photo by Howard Clifford. Courtesy of UW Libraries Special Collections" imageMeta={imgPACBarracks} />
...
<GalleryPhoto title="An Example Horse Stall for a Family" description="Photo by Dorothea Lange. Courtesy of National Archives" imageMeta={imgPACStall} />
